...
The process of converting double math into float math is fairly simple.  It does not attempt to parse the code and does not know if it's examining text inside of comments or not.
