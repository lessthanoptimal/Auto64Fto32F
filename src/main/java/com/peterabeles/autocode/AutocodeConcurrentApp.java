...
public class AutocodeConcurrentApp {
	...
	private static final FindProjectRoot findRootDirectory = AutocodeConcurrentApp::findPathToProjectRoot;
...
//				System.out.println(name+" "+e.getMessage());
	...
	/**
	 * Default function for finding project root
	 */
	public static File findPathToProjectRoot() {
		String path = "./";
		while (true) {
			File d = new File(path);
			if (new File(d, "gradlew").exists() && new File(d, "gradle.properties").exists())
				break;
			path = "../" + path;
		}
