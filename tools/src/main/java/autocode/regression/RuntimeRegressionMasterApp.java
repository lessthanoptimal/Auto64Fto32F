...
public class RuntimeRegressionMasterApp {
    ...
    public void performRegression() {
        ...
        var email = new org.ejml.EmailResults();
    ...
    private void createBaseline(org.ejml.EmailResults email, File baselineDir, boolean update ) {
        if (!update) {
    ...
    private void createSummary(org.ejml.EmailResults email, File currentDirectory,
