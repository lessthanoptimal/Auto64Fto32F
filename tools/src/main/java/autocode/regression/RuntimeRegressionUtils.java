...
public class RuntimeRegressionUtils {
    ...
    public static String createInfoSummaryText() {
        ...
        text += "Machine Name:  " + org.ejml.SettingsLocal.machineName + "\n";
    ...
    public static void saveSystemInfo( File directory, PrintStream err ) {
        try {
            ...
            out.println("Machine Name:  " + org.ejml.SettingsLocal.machineName);
            ...
            try {
                double[] load = org.ejml.SystemInfo.lookupSystemLoad();

                out.println("---- Native Access Info");
                out.println("OS: "+ org.ejml.SystemInfo.readOSVersion());
                out.println("CPU: "+ org.ejml.SystemInfo.readCpu());
