...
public class RuntimeRegressionSummary {
    ...
    public String createSummary() {
        ...
        summary += "\n";
        summary += "Machine:  " + org.ejml.SettingsLocal.machineName + " , " + org.ejml.RuntimeRegressionUtils.getHostName() + "\n";
    ...
    public static void main( String[] args ) throws IOException {
        ...
        Map<String, Double> current = org.ejml.RuntimeRegressionUtils.loadJmhResults(pathCurrent);
        Map<String, Double> baseline = org.ejml.RuntimeRegressionUtils.loadJmhResults(pathBaseline);
